        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="well profile">
                    <br>
                    <h3 class="name pull-left clearfix"> Category Name : {{ $category->name }}</h3>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="basic">
                                            <form class="form-horizontal" role="form"
                                                action="
                                                {{ route('admin.categories.update', ['id' => $category->id]) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')

                                                <div class="form-group">
                                                    <label for="inputfullname" class="col-lg-2 control-label">Category
                                                        Name</label>
                                                    <div class="col-lg-15">
