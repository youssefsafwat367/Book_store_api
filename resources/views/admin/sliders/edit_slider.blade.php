        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="well profile">
                    <br>
                    <h3 class="name pull-left clearfix"> slider Id : {{ $slider->id }}</h3>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="basic">
                                            <form class="form-horizontal" role="form"
                                                action="
                                                {{ route('admin.sliders.update', ['id' => $slider->id]) }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-15">
                                                        <select class="selectpicker" name="status">
                                                            <option value="appear" @selected($slider->status == 'appear')>appear
                                                            </option>
                                                            <option value="disappear" @selected($slider->status == 'disappear')>disappear
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                @enderror
                                                <br>
                                                <label for="inputfullname" class="col-lg-2 control-label">slider Image
                                                </label>
