                    ...
                    <tbody>
                        @forelse ($sliders as $slider)
                            <tr>
                                ...
                                <td>{{ $slider->status }}</td>
                                <td>
                                    <img src="{{ asset('assets/uploads/sliders') }}/{{$slider->image}}" alt="hello"
                                        style="width: 100px;">
                                </td>
                                <td>
                                    <a href="{{ route('admin.sliders.edit', ['id' => $slider->id]) }}" class="edit"><i
                                            class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <x-delete-button
                                        action="{{ route('admin.sliders.delete', ['id' => $slider->id]) }}"></x-delete-button>
